      ...
      <div class="container">
         ...
         <div id="adminTableView">
            ...
            <div class="input-group">
               ...
               <button  onclick="displayBookFields('bookFields');" type="button"
                  class="btn btn-outline-secondary btn-sm">Add a Movie</button>
               <button onclick="displayBookFields('bulkFields');" type="button" align="right"
                  class="btn btn-outline-secondary btn-sm">Bulk Import Movies</button>
               </span>
               <form  action="export.php" method="POST">
                  <button type="submit" name="export" class="btn btn-outline-secondary btn-sm" >Export Database</button>
               </form>
            </div>
            ...
            <div id="bulkFields">
               <form class="form" action="importCSV.php" method="POST" enctype="multipart/form-data">
                  Bulk Movie Upload File (.CSV): <br> <input type="file" name="file" maxlength="75" required> <br> <br>
            ...
            <table id="example" class="display dataTable" style="width: 100%;" role="grid" aria-describedby="example_info">
               <div class="table responsive">
                  <thead>
                     <tr>
                        <th> </th>
                        <th class="sorting_desc" tabindex="0" aria-controls="example" rowspan="1" colspan="1" style="width: 133px;" aria-label="Movie Name: activate to sort column ascending" aria-sort="descending">Movie Name</th>
                        <th>Year Made</th>
                        <th>Language</th>
                        <th>Lead Actor</th>
                        <th>Lead Actress</th>
                            ...
                            while($row = $tableResults->fetch_assoc()) {
                              $img = "images/".$row['image'];
                                echo '<tr>
                                          ...
                                          <td class="sorting_1"> '.$row["movie_name"].'</td>
                                          <td> '.$row["year_made"]. '</td>
                                          <td> '.$row["language"]. '</td>
                                          ...
                                          <td> '.$row["status"].' </td>
                                          <td><a class="btn btn-danger btn-sm" href="delete.php?id='.$row["movie_id"].'" onclick="return confirmDelete()">Delete</a></td>
            ...
            <table id="example" class="display dataTable" style="width: 100%;" role="grid" aria-describedby="example_info">
               <div >
                  <thead>
                     <tr role="row">
                        <th> </th>
                        <th class="sorting_asc" tabindex="0" aria-controls="example" rowspan="1" colspan="1" style="width: 133px;" aria-sort="ascending" aria-label="Movie Name: activate to sort column descending">Movie Name</th>
                        <th>Year Made</th>
                        <th>Language</th>
                        <th>Lead Actor</th>
                        <th>Lead Actress</th>
