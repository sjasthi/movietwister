...
<html lang="en">
   ...
   <body onload="displayAdminFields('admin1')">
	  ...
	  <table align="center" class="adminTable">
        ...
        <td align="center">
            <a href="movie_anagram_list.php"><img src="./icons/puzzle.png" class="adminThumbnailSize"></a>
        </td>
        ...
        <td align="center">
            <a href="import.php"><img src="./icons/import.png" class="adminThumbnailSize"></a>
        </td>
        <td align="center">
            <a href="reports.php"><img src="./icons/report.png" class="adminThumbnailSize"></a>
        </td>
		<td align="center">
            <a href="#"><img src="./icons/user.png" class="adminThumbnailSize"></a>
        </td>
		<td align="center">
            <a href="#"><img src="./icons/manual.png" class="adminThumbnailSize"></a>
        </td>
        
    </tr>
    <tr>
		<td align="center"><a href="movie_anagram_list.php">Anagram List</a></td>
        ...
        <td align="center"><a href="#">Manual</a></td>        
    </tr>
    <tr class="separator">
        <td></td>
    </tr>
