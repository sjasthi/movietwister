         ...
         <div id="adminTableView">
            ...
            <div id="bookFields">
               <form class="form" action="addMovie.php" method="POST">
                  ...
                  Lead Actor: <br> <input type="text" name="lead_actor" placeholder="Required" maxlength="4" required> <br>
                  Lead Actress: <br> <input type="text" name="lead_actress"  maxlength="255"> <br>
                  Director: <br> <input type="text" name="director"  maxlength="4"> <br>
                  Music Director: <br> <input type="text" name="music_director"  maxlength="255"> <br>
                  Other Cast: <br> <input type="text" name="other_cast"  maxlength="10"> <br>
...
<div id="wrap">
	...
	$query = "SELECT movie_id, year_made FROM movie_table";
	$stmt = $db->prepare($query);
	//$stmt->bind_param('s', $searchterm);  
	$stmt->execute();
	$stmt->store_result();

	$stmt->bind_result($movie_id, $year_made);
